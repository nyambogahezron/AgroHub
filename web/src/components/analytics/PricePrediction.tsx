	...
	return (
		<div className='bg-white rounded-lg shadow-md p-6'>
			...
			<p className='text-gray-600 mb-6'>
				Forecasted prices for the next 3 months based on historical data and
				market trends.
			</p>
								...
								{prediction.predictions.map((p, i) => (
									...
									>
										...
										<div className='flex items-center space-x-3'>
											...
											<span
												className={`flex items-center space-x-1 px-2 py-1 rounded-full text-xs border ${getClassName(
													p.trend
												)}`}
											>
												{getIcon(p.trend)}
